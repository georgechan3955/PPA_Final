...
# Extract longitude and latitude from the string format "c(-87.6277, 41.8819)"
...
# Create separate longitude and latitude columns
chicagogrocerystore <- chicagogrocerystore %>%
  mutate(
...
## Restaurant
restaurantchicago <- read.socrata("https://data.cityofchicago.org/resource/3e26-zek2.json")
